...
namespace CarBook.WebApi.Controllers
{
    ...
    public class AboutsController : ControllerBase
    {
        ...
        private readonly UpdateAboutComandHandler _updateAboutComandHandler;
        ...
        public AboutsController(CreateAboutCommandHandler createAboutCommandHandler,
            ...
            UpdateAboutComandHandler updateAboutComandHandler,
            RemoveAboutCommandHandler removeAboutCommandHandler)
        {
            _createAboutCommandHandler = createAboutCommandHandler;
            _getAboutByIdQueryHandler = getAboutByIdQueryHandler;
            _getAboutQueryHandler = getAboutQueryHandler;
            _updateAboutComandHandler = updateAboutComandHandler;
        ...
        {
            await _updateAboutComandHandler.Handle(command);
