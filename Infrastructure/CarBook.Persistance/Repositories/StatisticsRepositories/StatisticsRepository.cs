...
namespace CarBook.Persistence.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public decimal GetAvgRentPriceForDaily()
        {
            ...
            int id = _context.Pricings.Where(y => y.PricingName == "Günlük").Select(z => z.PricingID).FirstOrDefault();
        ...
        {
            int id = _context.Pricings.Where(y => y.PricingName == "Aylık").Select(z => z.PricingID).FirstOrDefault();
            var value = _context.CarPricings.Where(w => w.PricingID == id).Average(x => x.Amount);
            return value;
        }
        ...
        {
            int id = _context.Pricings.Where(y => y.PricingName == "Haftalık").Select(z => z.PricingID).FirstOrDefault();
            var value = _context.CarPricings.Where(w => w.PricingID == id).Average(x => x.Amount);
            return value;
        }
